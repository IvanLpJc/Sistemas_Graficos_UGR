...
class Crane extends THREE.Object3D {
  ...
  createBase () {
    var geometriaBase = new THREE.CylinderGeometry (this.craneWidth/10, this.craneWidth/10, this.baseHookHeight, 16, 1);
  ...
  createMast () {
    var geometriaMast = new THREE.CylinderGeometry (this.craneWidth/20, this.craneWidth/20, this.craneHeight, 16, 8);
  ...
  createJib () {
    var geometriaJib = new THREE.BoxGeometry (this.craneWidth, this.craneWidth/10, this.craneWidth/10);
  ...
  createTrolleyStringHook () {
    var geometriaTrolley = new THREE.BoxGeometry (this.craneWidth/10, this.trolleyHeight, this.craneWidth/10);
    ...
    var geometriaString = new THREE.CylinderGeometry (this.craneWidth/100, this.craneWidth/100, 1);
    ...
    var geometriaHook = new THREE.CylinderGeometry (this.craneWidth/40, this.craneWidth/40, this.baseHookHeight, 16, 1);
